  ...
  if (todo) {
    ...
    if (todo.completed && !wasCompleted) {
      ...
      if (newLevel > userLevel.value) {
        ...
        levelUpNotificationText.value = `?éâ Level Up! You are now level ${userLevel.value}!`;
...
async function generateAIResponse(userInput: string) {
  ...
  if (input.includes("help") || input.includes("assist")) {
    return "I'm here to help! I can assist you with:\n\n‚Ä¢ ?ìä Project management and progress tracking\n‚Ä¢ ‚ú? Task organization and prioritization\n‚Ä¢ ?éØ Business validation and planning\n‚Ä¢ ?é® Design and feature analysis\n‚Ä¢ ?ìã Checklist creation and management\n\nWhat would you like to work on today?";
  }

  if (input.includes("project") || input.includes("progress")) {
    return "Great! I can help you with project management. Here are some things we can do:\n\n‚Ä¢ ?ìà Review your current project progress\n‚Ä¢ ?éØ Set new milestones and goals\n‚Ä¢ ?ìã Create task lists and priorities\n‚Ä¢ ?îç Analyze project bottlenecks\n‚Ä¢ ?ìä Generate progress reports\n\nWhich project would you like to focus on?";
  }

  if (input.includes("task") || input.includes("todo")) {
    return "Task management is key to success! I can help you:\n\n‚Ä¢ ‚û? Create new tasks with priorities\n‚Ä¢ ?ìù Organize tasks by project or category\n‚Ä¢ ‚è∞ Set deadlines and reminders\n‚Ä¢ ?ìä Track completion rates\n‚Ä¢ ?éØ Prioritize your workload\n\nWould you like to add a new task or review your current list?";
  }
  ...
  if (
    ...
    return "Excellent! Let's work on your project strategy. I can help with:\n\n‚Ä¢ ?é® Design system and UI/UX planning\n‚Ä¢ ?íº Business model validation\n‚Ä¢ ?öÄ Feature prioritization and roadmap\n‚Ä¢ ?ìä Market analysis and competitor research\n‚Ä¢ ?éØ User experience optimization\n\nWhich aspect would you like to explore first?";
  }
  ...
  if (
    ...
    return "Hello there! ?ëã I'm your AI project assistant, ready to help you succeed! I can see you're working on some exciting projects. How can I help you today?\n\n?í° Tip: Try asking me about project progress, task management, or business planning!";
  }

  if (input.includes("checklist") || input.includes("check")) {
    return "Checklists are powerful productivity tools! I can help you:\n\n‚Ä¢ ?ìã Create comprehensive project checklists\n‚Ä¢ ‚ú? Track completion status\n‚Ä¢ ?îÑ Set up recurring task lists\n‚Ä¢ ?ìä Monitor checklist progress\n‚Ä¢ ?éØ Prioritize checklist items\n\nWould you like to create a new checklist or review existing ones?";
  }
  ...
  if (
    ...
    return "Business strategy is crucial! Let's analyze:\n\n‚Ä¢ ?ìä Market size and growth potential\n‚Ä¢ ?è¢ Competitive landscape analysis\n‚Ä¢ ?í∞ Revenue model validation\n‚Ä¢ ?éØ Target audience identification\n‚Ä¢ ?ìà Business metrics and KPIs\n\nWhat specific business aspect would you like to explore?";
  }
  ...
  if (
    ...
    return "Design is where creativity meets functionality! I can help with:\n\n‚Ä¢ ?é® UI/UX design principles and best practices\n‚Ä¢ ?éØ User journey mapping\n‚Ä¢ ?ì± Responsive design strategies\n‚Ä¢ ?é® Color schemes and typography\n‚Ä¢ ?îç Usability testing and optimization\n\nWhat design challenge are you facing?";
  }
  ...
  if (
    ...
    return "Technology choices can make or break a project! Let's discuss:\n\n‚Ä¢ ?íª Frontend and backend technologies\n‚Ä¢ ?óÑ?∏? Database and infrastructure options\n‚Ä¢ ?îß Development tools and frameworks\n‚Ä¢ ?ì± Mobile and web platform decisions\n‚Ä¢ ?îí Security and scalability considerations\n\nWhat's your current tech stack or what are you considering?";
  }

  // Default response with suggestions
  return `I understand you're asking about "${userInput}". Here are some ways I can help:\n\n‚Ä¢ ?öÄ **Project Planning**: Set goals, milestones, and timelines\n‚Ä¢ ?ìã **Task Management**: Organize and prioritize your work\n‚Ä¢ ?íº **Business Strategy**: Validate ideas and analyze markets\n‚Ä¢ ?é® **Design & UX**: Create user-friendly interfaces\n‚Ä¢ ?îß **Tech Decisions**: Choose the right technologies\n\nWhat would you like to focus on? I'm here to guide you through every step!`;
}
